    ...
    <div className="min-h-screen bg-gradient-dark relative overflow-hidden">
      ...
      <section className="relative z-10 container mx-auto px-4 min-h-screen flex flex-col items-center justify-center">
        <div className="text-center space-y-12">
          {showDollar && (
            <div className="animate-[scale-in_1.5s_ease-out,spin-slow_1.5s_ease-out,bounce-crazy_0.3s_ease-out_1.5s] inline-block">
              <img
                src={dollarSymbol}
                alt="Dollar Symbol"
                className="w-64 h-64 md:w-80 md:h-80 drop-shadow-mega"
              />
            </div>
          )}
